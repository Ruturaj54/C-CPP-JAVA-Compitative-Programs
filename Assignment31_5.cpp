...
void SinglyLL::DisplaySmallestDigit()
{
    PNODE Temp = first;
    int Size = CountNode();
    int Sum = 0;
...
void SinglyLL::DisplayLargestDigit()
{
    PNODE Temp = first;
    int Size = CountNode();
    int Sum = 0;
...
int main()
{
   ...
   while(1)
   {
        ...
        cout<<"13.Display Smallest Digit from the Linked list Elements : \n";
        cout<<"14.Display Largest Digit from the Linked list Elements : \n";
        cout<<"15.Exit\n";
        cin>>num;
        ...
        switch(num)
        {
            ...
            case 12:
                ...
                break;
            case 13:
                cout<<"Display Smallest Digit of Number of Linked List called\n";
                obj.DisplaySmallestDigit();
                cout<<"-----------------------------------------------------------------------------\n";
                break;
            case 14:
                cout<<"Display Largest Digit of Number of Linked List called\n";
